...
<template>
    ...
    <PageLayout title="" description="" endpoint="ingenierias.plantas.proyectos.levantamientos.cotizaciones">
        <template #breadcrumbs>
            <Link :href="LevantamientoController.show({
                planta: planta.id,
        ...
        <div class="overflow-hidden rounded-2xl border shadow-sm">
            <div
                ...
                <div class="flex flex-col items-end gap-2">
                    ...
                    <span class="rounded-md px-3 py-1 text-xs font-bold uppercase" :class="cotizacion.completada
                            ? 'bg-emerald-500'
                            : 'bg-white/20'
                        ">
                        {{
        ...
        <div class="mt-6 rounded-2xl border bg-card p-6 shadow-sm">
            ...
            <div class="mb-5 flex items-center justify-between text-sm font-medium">
                <span class="flex items-center gap-1.5" :class="cotizacion.tiene_insumos
                        ? 'text-emerald-600'
                        : 'text-muted-foreground'
                    ">
                    <span class="flex size-6 items-center justify-center rounded-full" :class="cotizacion.tiene_insumos
                ...
                <span class="flex items-center gap-1.5" :class="cotizacion.completada
                        ? 'text-emerald-600'
                        : 'text-muted-foreground'
                    ">
                    <span class="flex size-6 items-center justify-center rounded-full" :class="cotizacion.completada
                            ? 'bg-emerald-100 text-emerald-600'
                            : 'bg-muted'
                        ">
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="rounded-xl border p-4" :class="cotizacion.tiene_insumos
                        ? 'border-emerald-200 bg-emerald-50 dark:border-emerald-900 dark:bg-emerald-950/20'
                        : ''
                    ">
                    <div class="mb-3 flex items-center gap-2">
                        <Box class="size-5" :class="cotizacion.tiene_insumos
                                ? 'text-emerald-600'
                                : 'text-muted-foreground'
                            " />
                        <div>
                    ...
                    <Link :href="InsumoController.index({
                        ...
                        ">
                        <Button class="w-full" :class="cotizacion.tiene_insumos
            ...
            <div class="mt-5 flex items-start gap-3 rounded-lg border px-4 py-3" :class="cotizacion.completada
                ...
                ">
                <component :is="cotizacion.completada ? CheckCircle2 : Clock" class="mt-0.5 size-4 shrink-0" :class="cotizacion.completada
                        ? 'text-emerald-600'
                        : 'text-amber-600'
                    " />
                <div>
                    <p class="text-sm font-semibold" :class="cotizacion.completada
                    ...
                    <p class="text-sm" :class="cotizacion.completada
        ...
        <div class="mt-6 rounded-2xl border bg-card p-6 shadow-sm">
            ...
            <p v-if="!partidas.length" class="py-8 text-center text-sm text-muted-foreground">
                Aún no hay partidas.
            </p>
        </div>
    </PageLayout>
