...
<template>
    ...
    <PageLayout title="" description="">
        <div class="mx-auto max-w-5xl">
            <div
                class="mb-6 flex items-center gap-3 text-sm text-muted-foreground"
            >
            ...
            <div
                v-if="esCompletado && !tieneDocumento"
            ...
            <div
                class="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.15fr)]"
            >
                ...
                <section class="rounded-2xl border bg-card p-6 shadow-sm">
                    ...
                    <div
                        v-if="tieneDocumento"
                        class="mt-6 rounded-xl border bg-muted/30 p-4"
                    >
                    ...
                    <Button
                        v-if="tieneDocumento"
                        variant="ghost"
                        class="mt-2 w-full text-destructive hover:bg-destructive/10"
                        @click="eliminarPdf"
