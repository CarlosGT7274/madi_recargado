        ...
        <Card>
            ...
            <CardContent>
                <ul v-if="metricas.proyectosInconclusos.items.length" class="divide-y">
                    <li v-for="pry in metricas.proyectosInconclusos.items" :key="pry.id">
                        <Link :href="ProyectoController.show([pry.planta_id, pry.id])"
                            class="group flex items-center gap-3 py-3 transition-colors hover:bg-accent/50">
                            <div
                                class="flex size-10 shrink-0 items-center justify-center rounded-lg bg-amber-500/10 text-amber-600">
